...
public class ResponseEntityExceptionHandlerImpl extends ResponseEntityExceptionHandler {
	...
	public final ResponseEntity<ExceptionResponse> handleNotFoundException(UserDetailsNotFoundException ex,
			WebRequest request) {
	...
	@ExceptionHandler(TravellerDetailsNotFoundException.class)
	public final ResponseEntity<ExceptionResponse> handleNotFoundException(TravellerDetailsNotFoundException ex,
			WebRequest request) {
		ExceptionResponse exceptionResponse = new ExceptionResponse(LocalDate.now(), ex.getMessage(), "Not Found");
		log.info("An Exception occured");
		return new ResponseEntity<ExceptionResponse>(exceptionResponse, HttpStatus.NOT_FOUND);
