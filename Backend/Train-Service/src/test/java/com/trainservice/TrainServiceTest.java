...
class TrainServiceTest {
	...
	void testGetAllAvailableTrains_Empty() {
		...
		Date departure = java.sql.Date.valueOf("2023-06-19");
		assertThrows(TrainDetailsNotFoundException.class,
				() -> trainService.getAllAvailableTrains("CityA", "CityB", departure));
	}
	...
	void testBookTrain_NotFound() {
		...
		assertThrows(TrainDetailsNotFoundException.class,
				() -> trainService.bookTrain(1L, travellers, "SL", "CityA", "john"));
	}
