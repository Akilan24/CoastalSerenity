...
public class ResponseEntityExceptionHandlerImpl extends ResponseEntityExceptionHandler {
	...
	@ExceptionHandler(CabDetailsNotFoundException.class)
	public final ResponseEntity<ExceptionResponse> handleNotFoundException(CabDetailsNotFoundException ex,
			WebRequest request) {
